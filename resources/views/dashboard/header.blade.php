    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow mx-1">
            <a class="nav-link dropdown-toggle" href="#" id="cartDropdown" role="button"
                ...
                <!-- Counter - Cart -->
                <span class="badge bg-danger badge-counter" id="cart-count">{{ session('cart') ? count(session('cart')) : 0 }}</span>
            </a>
            ...
            <div class="dropdown-list dropdown-menu dropdown-menu-end shadow animated--grow-in"
                    ...
                    @if(session('cart') && count(session('cart')) > 0)
                        @foreach(session('cart') as $id => $item)
                            <a class="dropdown-item d-flex align-items-center" href="#">
                                <div class="mr-3">
                                    <img src="{{ asset('storage/' . $item['image']) }}" alt="Product Image" width="40" height="40" class="rounded">
                                </div>
                                <div>
                ...
                <a class="dropdown-item text-center small text-primary" href="{{ route('cart.index') }}">Go to Cart</a>
            </div>
        </li>
        <!-- Nav Item - Messages -->
        <li class="nav-item dropdown no-arrow mx-1">
